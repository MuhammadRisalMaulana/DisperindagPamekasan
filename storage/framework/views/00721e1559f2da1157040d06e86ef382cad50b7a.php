            ...
            <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    ...
                    <div class="bg-white p-6 rounded-md border border-gray-300 shadow mb-6">
                        ...
                        <form method="GET" action="<?php echo e(route('pengaduans.index')); ?>">
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status"
                                        ...
                                        <option value="Belum di Proses"
                                            <?php echo e(request('status') == 'Belum di Proses' ? 'selected' : ''); ?>>
                                            Belum di Proses</option>
                                        <option value="Sedang di Proses"
                                            <?php echo e(request('status') == 'Sedang di Proses' ? 'selected' : ''); ?>>
                            ...
                            <div class="flex justify-end gap-3 mt-6">
                                ...
                                <a href="<?php echo e(route('pengaduans.index')); ?>"
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div class="relative hidden mr-3  md:block">
                                                <img class=" h-32 w-35 " src="<?php echo e(Storage::url($item->image)); ?>"
                                                    alt="" loading="lazy" />
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div class="px-4 py-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex flex-col items-center justify-between space-y-4 md:flex-row">
                            <span class="text-sm text-gray-700 dark:text-gray-300">
                                Menampilkan <?php echo e($items->firstItem()); ?> - <?php echo e($items->lastItem()); ?> dari
                                <?php echo e($items->total()); ?> data
                            </span>

                            <div>
                                <?php echo e($items->links('vendor.pagination.tailwind_next_back')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DISPERINDAG_PROJECT-main\resources\views/pages/admin/pengaduan/index.blade.php ENDPATH**/ ?>