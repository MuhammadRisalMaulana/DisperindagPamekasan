    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <?php if(Auth::user()->roles == 'ADMIN'): ?>
            <ul>
                <li class="relative px-6 py-3">
                    <span
                        class="<?php echo e(request()->is('admin/log-aktivitas') ? 'absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg' : ''); ?>"
                        aria-hidden="true"></span>
                    <a href="<?php echo e(url('admin/log_aktivitas')); ?>"
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200
              <?php echo e(request()->is('admin/log-aktivitas') ? 'text-gray-800 dark:text-gray-200' : ''); ?>">
                        <svg class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
        ...
        <ul>
            <li class="relative px-6 py-3">
                <span
                    class="<?php echo e(request()->is('admin/berita') ? 'absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg' : ''); ?>"
                    aria-hidden="true"></span>
