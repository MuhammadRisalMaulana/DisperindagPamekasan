        ...
        <ul class="flex items-center flex-shrink-2 space-x-6">
            ...
            <li class="relative">
                <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                    ...
                    aria-haspopup="true">
                    <img class="object-cover w-8 h-8 rounded-full" src="<?php echo e(asset('img/profil.png')); ?>"
...
<?php /**PATH C:\xampp\htdocs\DISPERINDAG_PROJECT-main\resources\views/includes/admin/navbar.blade.php ENDPATH**/ ?>