<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
  <div class="container flex items-center justify-end h-full px-6 mx-auto text-green-600 dark:text-green-300">
    ...
    <div class="flex justify-center flex-1">
      ...
      <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 "
        href="<?php echo e(url('pengaduan')); ?>">

        <span class="ml-4">Pengaduan</span>
      </a>

      <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 "
        href="<?php echo e(url('/pengaduan/status')); ?> ">

        <span class="ml-4">Cek Pengaduan</span>
      </a>

      
    <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 hover:text-green-200"
       href="#lokasi">
        <span class="ml-4">Lokasi</span>
    </a>

    <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 hover:text-green-200"
       href="<?php echo e(url('/berita')); ?>">
...
</header><?php /**PATH C:\xampp\htdocs\DISPERINDAG_PROJECT-main\resources\views/includes/masyarakat/navbar.blade.php ENDPATH**/ ?>