        ...
        <div class="container px-6 mx-auto grid">
            ...
            @if ($pending > 0)
                <div class="p-4 mb-6 bg-yellow-100 border border-yellow-400 text-yellow-700 rounded">
                    Ada <strong>{{ $pending }}</strong> pengaduan baru yang belum diproses.
                    <a href="{{ url('/admin/pengaduans') }}" class="underline">Lihat sekarang</a>
                </div>
            @endif
    ...
    @push('scripts')
        ...
        <script>
            ...
            const chart = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: {!! json_encode($bulanChart) !!}, // Contoh: ["Jan", "Feb", "Mar"]
                    datasets: [{
                        label: 'Jumlah Pengaduan',
                        data: {!! json_encode($jumlahChart) !!}, // Contoh: [5, 12, 7]
